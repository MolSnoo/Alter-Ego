...
the [editmode command](../reference/commands/moderator_commands.md#editmode).
...
by a moderator with the [load command](../reference/commands/moderator_commands.md#load). By keeping an
...
can be set with the [autoSaveInterval setting](../reference/settings/docker_settings.md#autosave_interval).
...
and [Gesture](../reference/data_structures/gesture.md) sheets remain unaffected by the saving process), this
...
ways (the other being the [save command](../reference/commands/moderator_commands.md#save)) of forcibly saving
...
In addition, [Players](../reference/data_structures/player.md) are unable to use commands during edit mode.
They are still able to speak (and thus use the [say command](../reference/commands/player_commands.md#say)),
...
[`unconscious` behavior attribute](../reference/data_structures/status.md#unconscious). As Players are
...
* When applicable, load related data structures. For example, if manually
  editing [Items](../reference/data_structures/item.md), load
  the [Objects](../reference/data_structures/object.md)
