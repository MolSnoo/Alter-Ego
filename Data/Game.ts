...
export default class Game {
    ...
    */
    ...
    /**
     * Rolls a standard die using the min and max values in the game's settings.
     ...
     */
    rollDie(stat?: string, attacker?: Player, defender?: Player): Die {
        return new Die(this, stat, attacker, defender);
    }

    /**
     * Rolls a die with custom min and max values.
     * @param min - The minimum possible roll.
     * @param max - The maximum possible roll.
     * @param stat - The name of the stat to roll for.
     * @param attacker - The active player to roll for. In other words, the player attempting an action.
     * @param defender - The passive player to roll for. Only used if the attacker is attempting to perform an action against another player.
     */
    rollCustomDie(min: number, max: number, stat?: string, attacker?: Player, defender?: Player): Die {
        return new Die(this, stat, attacker, defender, min, max);
    }
