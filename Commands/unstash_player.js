...
export async function execute (game, message, command, args, player) {
    ...
    if (hand === undefined) return messageHandler.addReply(game, message, "You do not have a free hand to retrieve an item. Either drop an item you're currently holding or stash it in one of your equipped items.");
