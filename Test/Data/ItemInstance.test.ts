...
describe('ItemInstance test', () => {
    ...
    describe('proceduralSelections test', () => {
        ...
        test('InventoryItem FIRED CLAY POT proceduralSelections', () => {
            const entity = game.entityFinder.getInventoryItem('FIRED CLAY POT 91', 'QM', undefined, 'RIGHT HAND');
            const expected = new Map<string, string>([
                ["base color", "red"],
                ["quality", "excellent"]
            ]);
        ...
        test('InventoryItem GLAZE proceduralSelections', () => {
            const entity = game.entityFinder.getInventoryItem('GLAZE', 'QM', undefined, 'LEFT HAND');
            const expected = new Map<string, string>([
