...
describe('test parseDescription', () => {
    ...
    beforeAll(async () => {
        ...
        evad = testGame.entityFinder.getPlayer("Evad");
    ...
    describe('test item lists', () => {
        test('empty item list 0', () => {
            const description = new Description(`<desc><s>The floor beneath you is soft and earthy.</s> <s>You find <il></il> haphazardly placed on it.</s></desc>`, null, testGame);
        ...
        test('empty item list 1', () => {
            const description = new Description(`<desc><s>You look at the sink.</s> <s>It looks to be very clean.</s> <s>On the wall above it is a mirror.</s> <s>Under the sink, you find <il></il>.</s></desc>`, null, testGame);
        ...
        test('single item list single item 0', () => {
            const description = new Description(`<desc><s>You open the locker.</s> <s>Inside, you find <il><item>a pair of SWIM TRUNKS</item></il>.</s></desc>`, null, testGame);
        ...
        test('single item list multiple items 0', () => {
            const description = new Description(`<desc><desc><s>You open the locker.</s> <s>Inside, you find <il><item>a FIRST AID KIT</item>, <item>a bottle of PAINKILLERS</item>, <item>a PILL BOTTLE</item>, and <item>an OLD KEY</item></il>.</s></desc></desc>`, null, testGame);
        ...
        test('multiple empty item lists 0', () => {
            const description = new Description(`<desc><s>It's a pair of long, purple pants with a checker pattern.</s> <s>There are four pockets altogether.</s> <s>In the left pocket, you find <il name="LEFT POCKET"></il>.</s> <s>In the right pocket, you find <il name="RIGHT POCKET"></il>.</s> <s>In the left back pocket, you find <il name="LEFT BACK POCKET"></il>.</s> <s>In the right back pocket, you find <il name="RIGHT BACK POCKET"></il>.</s></desc>`, null, testGame);
        ...
        test('multiple item lists single items 0', () => {
            const description = new Description(`<desc><s>It's a pair of long, purple pants with a checker pattern.</s> <s>There are four pockets altogether.</s> <s>In the left pocket, you find <il name="LEFT POCKET"><item>a GUN</item></il>.</s> <s>In the right pocket, you find <il name="RIGHT POCKET"></il>.</s> <s>In the left back pocket, you find <il name="LEFT BACK POCKET"></il>.</s> <s>In the right back pocket, you find <il name="RIGHT BACK POCKET"><item>3 pairs of DICE</item></il>.</s></desc>`, null, testGame);
    ...
    describe('test player perception', () => {
        describe('joshua body', () => {
            ...
            beforeAll(() => {
                description = new Description(`<desc><s>You inspect Joshua's body.</s> <if cond="player.perception >= 5"><s>He looks pretty emaciated, like he hasn't eaten or drank in days.</s> <s>You don't find any injuries except for a gash in his **NECK**.</s></if> <if cond="player.perception < 5"><s>Nothing seems out of the ordinary except for a gash in his **NECK**.</s></if></desc>`, null, testGame);
            });
        ...
        describe('veronica with conditional items', () => {
            ...
            beforeAll(() => {
                description = new Description(`<desc><s>You find Veronica's body lying face up.</s> <s>Her arms are extended straight out with her palms facing up.</s> <s>There's a bloody WOUND on her chest, and the blood has soaked her shirt.</s> <s>In her pockets, you find <il><item>a CIGARETTE</item><if cond="player.perception >= 5">, <item>a KNIFE</item>,</if> and <item>a pair of NEEDLES</item></il>.</s></desc>`, null, testGame);
            });
        ...
        test('veronica perception 5 with empty item list', () => {
            const description = new Description(`<desc><s>You find Veronica's body lying face up.</s> <s>Her arms are extended straight out with her palms facing up.</s> <s>There's a bloody WOUND on her chest, and the blood has soaked her shirt.</s> <if cond="player.perception >= 5"><s>In her pockets, you find <il></il>.</s></if></desc>`, null, testGame);
            const expected = `You find Veronica's body lying face up. Her arms are extended straight out with her palms facing up. There's a bloody WOUND on her chest, and the blood has soaked her shirt.`;
            const result = parseDescription(description, null, nero);
            expect(result).toBe(expected);
        });
    ...
    describe('test player title', () => {
        ...
        describe('pool table', () => {
            ...
            beforeAll(() => {
                description = new Description(`<desc><s>You examine the pool table.</s> <s>It seems to have everything you need to play a game of pool: <il><item>2 POOL STICKS</item>, <if cond="player.title === 'Ultimate Gamer'"><item>CHALK</item>,</if> <item>a TRIANGLE</item>, and <item>BALLS</item></il>.</s></desc>`, null, testGame);
            });
        ...
        describe('locker conditional title', () => {
            ...
            beforeAll(() => {
                description = new Description(`<desc><s>You open the locker.</s> <s>Inside, you find <il><if cond="player.title === 'Ultimate Nurse'"><item>a SWIMSUIT</item></if></il>.</s></desc>`, null, testGame);
            });
    ...
    describe('test inventory items', () => {
        describe('mountain dew', () => {
            ...
            beforeAll(() => {
                description = new Description(`<desc><s>It's a bottle of Code Red Mountain Dew, which has a cherry flavor.</s> <if cond="player.name === 'Asuka'"><s>This is your favorite flavor, naturally.</s></if><if cond="player.name !== 'Asuka'"><s>For some reason, when you hold it, you get the urge to play video games.</s></if> <s>The drink and label are both red.</s> <if cond="this.uses > 0"><s>It's nice and cold.</s></if><if cond="this.uses === 0"><s>It's empty.</s></if></desc>`, null, testGame);
                item = testGame.entityFinder.getRoomItem('CODE RED MOUNTAIN DEW');
            });
        ...
        describe('sniper rifle', () => {
            ...
            beforeAll(() => {
                description = new Description(`<desc><s>It's a long, black sniper rifle with an attached scope.</s> <s>It's the kind that you have to lodge into your shoulder to hold steadily.</s> <s>It's loaded with a 10-round box magazine.</s> <if cond="this.uses > 0"><s><var v="this.uses" /> shot<if cond="this.uses !== 1">s are</if><if cond="this.uses === 1"> is</if> left.</s></if><if cond="this.uses === 0"><s>Unfortunately, all the ammo has been depleted.</s></if></desc>`, null, testGame);
                item = testGame.entityFinder.getRoomItem('SNIPER RIFLE');
            });
    ...
    describe('test events', () => {
        ...
        describe('multiple events winter checkpoint', () => {
            ...
            beforeAll(() => {
                ...
                container = testGame.entityFinder.getRoom('path-2');
                snowEvent = testGame.entityFinder.getEvent('SNOW');
                blizzardEvent = testGame.entityFinder.getEvent('BLIZZARD');
                overcastEvent = testGame.entityFinder.getEvent('OVERCAST');
                nightEvent = testGame.entityFinder.getEvent('NIGHT');
            });
    ...
    describe('test formatting', () => {
        test('greater than less than', () => {
            const description = new Description(`<desc><s>It's a graph of an algebraic expression.</s> <s>In the corner, "x > -2 && x < 3" is written.</s></desc>`, null, testGame);
        ...
        test('less than greater than', () => {
            const description = new Description(`<desc><s>It's a graph of an algebraic expression.</s> <s>In the corner, "x < 3 && x > -2" is written.</s></desc>`, null, testGame);
        ...
        test('broken opening desc tag', () => {
            const description = new Description(`desc><s>It’s a raspberry blue blanket filled with plastic pellets that weigh it down.</s> <s>It weighs 10 pounds and is very comforting.</s></desc>`, null, testGame);
        ...
        test('duplicate closing desc tag', () => {
            const description = new Description(`</desc><s>It's a wide, boxy typewriter set into a wooden base.</s> <s>There is a *QWERTZ* keyboard set into the front that makes heavy, noisy clicks whenever the keys are pressed down.</s> <s>A cylinder at the back of the typewriter has a roll of paper clipped in.</s> <s>When a key is typed, ink stamps down onto the paper, producing letters onto the paper.</s> <s>There are visible signs of aging on this typewriter, as if it’s accompanied its owner for many years.</s> <s>Despite the small placard below the keyboard reading “NEO-TYPEWRITER”, nothing about it seems particularly futuristic.</s></desc>`, null, testGame);
    ...
    describe('item lists are generated automatically', () => {
        test('empty item list', () => {
            const container = testGame.entityFinder.getFixture('FLOOR', 'lobby');
        ...
        test('only a fixture', () => {
            const container = testGame.entityFinder.getFixture('COUCH', 'break-room');
        ...
        test('one item quantity 1', () => {
            const container = testGame.entityFinder.getFixture('DRAWER 2', 'kitchen');
        ...
        test('one item quantity 30', () => {
            const container = testGame.entityFinder.getFixture('BEEF PALLET', 'freezer');
        ...
        test('one item infinite quantity', () => {
            const container = testGame.entityFinder.getFixture('PANTRY', 'canteen');
        ...
        test('one item and flavor text', () => {
            const container = testGame.entityFinder.getFixture('COFFEE TABLE', 'lobby');
        ...
        test('one item and a fixture', () => {
            const container = testGame.entityFinder.getFixture('NIGHTSTAND', 'suite-1');
        ...
        test('one item and two fixtures', () => {
            const container = testGame.entityFinder.getFixture('DESK', 'warehouse-office');
        ...
        test('two items and two fixtures', () => {
            const container = testGame.entityFinder.getFixture('BED', 'cell-1');
        ...
        test('two items single quantity', () => {
            const container = testGame.entityFinder.getFixture('TABLE 1', 'dining-hall');
        ...
        test('two items quantity 6', () => {
            const container = testGame.entityFinder.getFixture('CUPBOARDS', 'break-room');
        ...
        test('two items and a fixture', () => {
            const container = testGame.entityFinder.getFixture('COFFEE TABLE', 'green-room');
        ...
        test('multiple items with infinite quantities', () => {
            const container = testGame.entityFinder.getFixture('FRUIT BASKET', 'kitchen');
        ...
        test('three items with conditional', () => {
            const container = testGame.entityFinder.getFixture('BED', 'suite-14');
        ...
        test('three items with mixed singleContainingPhrases and pluralContainingPhrase', () => {
            const container = testGame.entityFinder.getFixture('PROP TABLE', 'backstage');
        ...
        test('four items', () => {
            const container = testGame.entityFinder.getFixture('PREP TABLE', 'canteen');
        ...
        test('many items with the same plural name', () => {
            const container = testGame.entityFinder.getFixture('POOL TABLE', 'break-room');
        ...
        test('items with the same prefab but different uses are collated', () => {
            const container = testGame.entityFinder.getFixture('SINK 1', 'video-room');
        ...
        test('container items with the same prefab are collated', () => {
            const container = testGame.entityFinder.getFixture('BURNER 5', 'video-room');
        ...
        test('items with the same prefab but different names are not collated', () => {
            const container = testGame.entityFinder.getFixture('KILN 3', 'video-room');
        ...
        test('multiple empty item lists', () => {
            const container = testGame.entityFinder.getRoomItem('KYRAS PANTS 2', 'suite-9');
        ...
        test('one item in description with multiple item lists', () => {
            const container = testGame.entityFinder.getRoomItem('RILEY SHORTS', 'dressing-room');
        ...
        test('some filled item lists', () => {
            const container = testGame.entityFinder.getRoomItem('KNIFE BLOCK', 'kitchen');
        ...
        test('all filled item lists', () => {
            const container = testGame.entityFinder.getRoomItem('CLEANING CART', 'storage');
        ...
        test('items with the same single and plural containing phrases are combined', () => {
            const container = testGame.entityFinder.getFixture('CLOSET', 'suite-9');
        ...
        test('last word before item list "are" is changed to "is" when only 1 item with a quantity of 1 remains', () => {
            const container = testGame.entityFinder.getRoomItem('BOX OF SPAGHETTI 2', 'kitchen');
        ...
        test('last word before item list "are" is remains "are" when only 1 item with a quantity greater than 1 remains', () => {
            const container = testGame.entityFinder.getRoomItem('BOX OF SPAGHETTI 1', 'kitchen');
        ...
        test('last word before item list "is" remains "is" when it contains 1 item with a quantity of 1', () => {
            const container = testGame.entityFinder.getRoomItem('KYRAS BRA 29', 'suite-9');
        ...
        test('last word before item list "is" is changed to "are" when it contains 1 item with a quantity greater than 1', () => {
            const container = testGame.entityFinder.getRoomItem('KYRAS BRA 30', 'suite-9');
        ...
        test('last word before item list "is" is changed to "are" when it contains more than 1 item', () => {
            const container = testGame.entityFinder.getRoomItem('KYRAS BRA 31', 'suite-9');
        ...
        test('first word after item list "is" is changed to "are" when it contains 1 item with a quantity greater than 1', () => {
            const monokumaMask = testGame.entityFinder.getRoomItem('MONOKUMA MASK', 'treasure-room');
            monokumaMask.quantity = 2;
            const container = testGame.entityFinder.getFixture('HOOK', 'treasure-room');
        ...
        test('first word after item list "are" is changed to "is" when it contains 1 item with a quantity of 1', () => {
            const smallWeight = testGame.entityFinder.getRoomItem('SMALL WEIGHT', 'fitness-room');
            const mediumWeight = testGame.entityFinder.getRoomItem('MEDIUM WEIGHT', 'fitness-room');
            const heavyWeight = testGame.entityFinder.getRoomItem('HEAVY WEIGHT', 'fitness-room');
            smallWeight.quantity = 0;
            mediumWeight.quantity = 0;
            heavyWeight.quantity = 1;
            const container = testGame.entityFinder.getFixture('WEIGHT RACK', 'fitness-room');
    ...
    describe('test description contains other description', () => {
        test('item in child puzzle', () => {
            const container = testGame.entityFinder.getFixture('LOCKER 1', 'locker-room');
        ...
        test('realistic fiction section contains already solved description', () => {
            const container = testGame.entityFinder.getFixture('REALISTIC FICTION SECTION', 'library');
        ...
        test('brazen bull contains empty already solved description', () => {
            const container = testGame.entityFinder.getFixture('BRAZEN BULL', 'torture-chamber');
        ...
        test('bottom dresser drawer contains already solved description', () => {
            const container = testGame.entityFinder.getFixture('BOTTOM DRESSER DRAWER', 'suite-7');
        ...
        test('mirror shows player description', () => {
            const container = testGame.entityFinder.getFixture('MIRROR', 'locker-room');
