...
describe('instantiate_bot command', () => {
    ...
    describe('inventory items', () => {
        ...
        describe('invalid invocations (prefab)', () => {
            test('1 invalid item without procedural selections into valid player equipment slot', async () => {
                ...
                expect(testGame.guildContext.commandChannel.send).toBeInvokedWith("Error: Couldn't execute command \"create something very scary in kyra's left hand\". Couldn't find prefab with id \"SOMETHING VERY SCARY\".");
            });
            ...
            test('1 invalid item with procedural selections into valid player equipment slot', async () => {testGame.guildContext.commandChannel.send
                ...
                expect(spy).not.toHaveBeenCalled();
                expect(context).toBeUndefined();
                expect(testGame.guildContext.commandChannel.send).toBeInvokedWith("Error: Couldn't execute command \"create something very scary (scary = true) in kyra's left hand\". Couldn't find prefab with id \"SOMETHING VERY SCARY\".");
            });
        });
        ...
        describe('invalid invocations (location)', () => {
            test('1 valid item without procedural selections containing 9 items with valid procedural selections into invalid player equipment slot', async () => {testGame.guildContext.commandChannel.send
                const args = [
                    "pack", "of", "pens",
                    "containing",
                    "3", "pen", "(ink", "color", "=", "red)", "+",
        ...
        describe('invalid invocations (syntax)', () => {
            test('1 valid item without procedural selections and invalid containing syntax into valid player equipment slot', async () => {testGame.guildContext.commandChannel.send
                const args = [
                    "pack", "of", "pens",
                    "containing",
                    "in",
    ...
    describe('room items', () => {
        ...
        describe('invalid invocations (quantity)', () => {
            test('1 valid item without procedural selections with 10 capacity containing 11 items with valid procedural selections into valid fixture', async () => {testGame.guildContext.commandChannel.send
                const args = [
                    "pack", "of", "pens",
                    "containing",
                    "4", "pen", "(ink", "color", "=", "red)", "+",
        ...
        describe('invalid invocations (location)', () => {
            test('1 valid item without procedural selections containing 9 items with valid procedural selections into invalid fixture', async () => {testGame.guildContext.commandChannel.send
                const args = [
                    "pack", "of", "pens",
                    "containing",
                    "3", "pen", "(ink", "color", "=", "red)", "+",
        ...
        describe('invalid invocations (syntax)', () => {
            test('1 valid item without procedural selections and invalid containing syntax into valid fixture', async () => {testGame.guildContext.commandChannel.send
                const args = [
                    "pack", "of", "pens",
                    "containing",
                    "on",
            ...
            test('1 valid item without procedural selections and nested containing syntax into valid player equipment slot', async () => {testGame.guildContext.commandChannel.send
                ...
                expect(spy).not.toHaveBeenCalled();
                expect(context).toBeUndefined();
                expect(testGame.guildContext.commandChannel.send).toBeInvokedWith("Error: Couldn't execute command \"create pack of pens containing pack of pens containing pack of pens in pot of pot 1 at kitchen\". Couldn't find prefab \"PACK OF PENS CONTAINING PACK OF PENS\".");
            });
        });
    });
});
