...
describe("GameEntityFinder test", () => {
    ...
    describe("getRoomItem test", () => {
        test("Get valid item", () => {
            ...
            expect(foundItem2.name).toBe("BLACK BREECHES");
            expect(foundItem2.pluralName).toBe("");
            expect(foundItem2.singleContainingPhrase).toBe("a pair of BLACK BREECHES");
            ...
            expect(foundItem3.name).toBe("BLACK BREECHES");
            expect(foundItem3.pluralName).toBe("");
            expect(foundItem3.singleContainingPhrase).toBe("a pair of BLACK BREECHES");
            ...
            expect(foundItem4.name).toBe("WAFFLES");
            expect(foundItem4.pluralName).toBe("");
            expect(foundItem4.singleContainingPhrase).toBe("a serving of frozen WAFFLES");
            expect(foundItem4.pluralContainingPhrase).toBe("servings of frozen WAFFLES");
    ...
    describe("getPlayer test", () => {
        ...
        test("Get valid player with special characters by name", () => {
            let player = game.entityFinder.getPlayer("QM");
            expect(player).toBeInstanceOf(Player);
    ...
    describe("getExits test", () => {
        ...
        test("Get all exits if unlocked", () => {
            ...
            for (const exit of exits) {
                expect(exit.name).
                    toBeOneOf(["HALL 2", "HALL 4", "REVOLVING DOOR 1", "REVOLVING DOOR 2", "KITCHEN", "FITNESS ROOM"]);
            }
        });
